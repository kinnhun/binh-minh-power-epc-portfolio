...
export default function Navbar() {
  ...
  const navItems = [
    { label: "Giải pháp", href: "epc-benefits", hasDropdown: false },
    { label: "Dự án", href: "epc-projects", hasDropdown: false },
    { label: "Quy trình EPC", href: "epc-process", hasDropdown: false },
    { label: "Tư vấn ESG", href: "epc-faq", hasDropdown: true },
  ];
    ...
    >
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          {/* Slender Hotline Link Capsule - hidden on small mobile viewports */}
          <motion.a
            href="tel:0913943788"
          ...
          >
            ...
            <div className="flex flex-col text-left leading-none pr-1">
              ...
              <span className={cn(
                "font-black text-xs mt-0.5 transition-colors duration-300 whitespace-nowrap",
          ...
          >
            ...
            <div className={cn(
              ...
              isScrolled ? "bg-white/20 text-white" : "bg-black/10 text-deep-brown"
            )}>
              <ArrowUpRight className="w-2.5 h-2.5 text-current" />
            </div>

            <span className="relative z-10 whitespace-nowrap">Khảo sát miễn phí</span>
          </motion.button>
        </div>
