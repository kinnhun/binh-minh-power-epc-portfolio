...
export default function BottomRightCorner() {
  ...
  return (
    <motion.div
      ...
      className="absolute -bottom-[1px] -right-[1px] p-3 pt-5 pl-8 sm:p-4 sm:pt-6 sm:pl-10 md:p-6 md:pt-8 md:pl-14 bg-rivr-bg rounded-tl-[1.5rem] sm:rounded-tl-[2rem] md:rounded-tl-[3.5rem] flex items-center gap-3 sm:gap-4 md:gap-6 z-20 select-none"
    >
      ...
      <button 
        ...
        className="bg-cream-base border border-solar-gold/20 w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center hover:bg-solar-gold/15 hover:scale-105 transition-all duration-300 cursor-pointer focus:outline-none shrink-0 group animate-pulse-glow"
      >
