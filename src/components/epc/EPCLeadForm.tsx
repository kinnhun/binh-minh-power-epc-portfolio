                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 text-left">
                    ...
                    <div className="pt-4">
                      <motion.button
                        ...
                        className="w-full py-4 rounded-full bg-solar-gold hover:bg-solar-gold-hover active:bg-solar-gold-active text-deep-brown font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all duration-200 cursor-pointer disabled:opacity-60 focus:outline-none animate-pulse-glow"
                      >
                        {isSubmitting ? (
                          <>
